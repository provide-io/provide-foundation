...
def validate_algorithm(*args, **kwargs):
    result = _mutmut_trampoline(x_validate_algorithm__mutmut_orig, x_validate_algorithm__mutmut_mutants, args, kwargs)
    return result 
...
def is_secure_algorithm(*args, **kwargs):
    result = _mutmut_trampoline(x_is_secure_algorithm__mutmut_orig, x_is_secure_algorithm__mutmut_mutants, args, kwargs)
    return result 
...
def get_digest_size(*args, **kwargs):
    result = _mutmut_trampoline(x_get_digest_size__mutmut_orig, x_get_digest_size__mutmut_mutants, args, kwargs)
    return result 
