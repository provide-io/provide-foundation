...
class ExtractionTracker:
    ...
    def __init__(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁ__init____mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁ__init____mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    def check_file_count(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁcheck_file_count__mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁcheck_file_count__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    def check_file_size(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁcheck_file_size__mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁcheck_file_size__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    def add_extracted_size(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁadd_extracted_size__mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁadd_extracted_size__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    def set_compressed_size(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁset_compressed_size__mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁset_compressed_size__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    def check_compression_ratio(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁcheck_compression_ratio__mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁcheck_compression_ratio__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    check_compression_ratio.__signature__ = _mutmut_signature(
        xǁExtractionTrackerǁcheck_compression_ratio__mutmut_orig
    )
    xǁExtractionTrackerǁcheck_compression_ratio__mutmut_orig.__name__ = (
        "xǁExtractionTrackerǁcheck_compression_ratio"
    )

    def xǁExtractionTrackerǁvalidate_member_size__mutmut_orig(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_1(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_2(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_3(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_4(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_5(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_6(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_7(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_8(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_9(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_10(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_11(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_12(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_13(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_14(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_15(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_16(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_17(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_18(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_19(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_20(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_21(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_22(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_23(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def xǁExtractionTrackerǁvalidate_member_size__mutmut_24(
        self, member_size: int, compressed_member_size: int | None = None
    ) -> None:
        """Validate a single archive member before extraction.
    ...
    def validate_member_size(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁExtractionTrackerǁvalidate_member_size__mutmut_orig"),
            object.__getattribute__(self, "xǁExtractionTrackerǁvalidate_member_size__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    validate_member_size.__signature__ = _mutmut_signature(
        xǁExtractionTrackerǁvalidate_member_size__mutmut_orig
    )
