...
def encode_basic_auth(*args, **kwargs):
    result = _mutmut_trampoline(
        x_encode_basic_auth__mutmut_orig, x_encode_basic_auth__mutmut_mutants, args, kwargs
    )
    return result
...
def get_auth_headers(*args, **kwargs):
    result = _mutmut_trampoline(
        x_get_auth_headers__mutmut_orig, x_get_auth_headers__mutmut_mutants, args, kwargs
    )
    return result
...
def validate_credentials(*args, **kwargs):
    result = _mutmut_trampoline(
        x_validate_credentials__mutmut_orig, x_validate_credentials__mutmut_mutants, args, kwargs
    )
    return result
