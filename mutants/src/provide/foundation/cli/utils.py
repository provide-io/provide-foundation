...
def setup_cli_logging(*args, **kwargs):
    result = _mutmut_trampoline(
        x_setup_cli_logging__mutmut_orig, x_setup_cli_logging__mutmut_mutants, args, kwargs
    )
    return result
...
def create_cli_context(*args, **kwargs):
    result = _mutmut_trampoline(
        x_create_cli_context__mutmut_orig, x_create_cli_context__mutmut_mutants, args, kwargs
    )
    return result
...
class CliTestRunner:
    ...
    def __init__(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁCliTestRunnerǁ__init____mutmut_orig"),
            object.__getattribute__(self, "xǁCliTestRunnerǁ__init____mutmut_mutants"),
            args,
            kwargs,
            self,
        )
    ...
    def invoke(self, *args, **kwargs):
        result = _mutmut_trampoline(
            object.__getattribute__(self, "xǁCliTestRunnerǁinvoke__mutmut_orig"),
            object.__getattribute__(self, "xǁCliTestRunnerǁinvoke__mutmut_mutants"),
            args,
            kwargs,
            self,
        )
...
def assert_cli_success(*args, **kwargs):
    result = _mutmut_trampoline(
        x_assert_cli_success__mutmut_orig, x_assert_cli_success__mutmut_mutants, args, kwargs
    )
    return result
...
def assert_cli_error(*args, **kwargs):
    result = _mutmut_trampoline(
        x_assert_cli_error__mutmut_orig, x_assert_cli_error__mutmut_mutants, args, kwargs
    )
    return result
