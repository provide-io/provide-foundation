...
def x_prepare_environment__mutmut_4(env: Mapping[str, str] | None) -> dict[str, str]:
    ...
    return prepare_subprocess_environment(caller_overrides=env, )
...
def prepare_environment(*args, **kwargs):
    result = _mutmut_trampoline(x_prepare_environment__mutmut_orig, x_prepare_environment__mutmut_mutants, args, kwargs)
    return result 
...
def create_completed_process(*args, **kwargs):
    result = _mutmut_trampoline(x_create_completed_process__mutmut_orig, x_create_completed_process__mutmut_mutants, args, kwargs)
    return result 
...
def check_process_exit_code(*args, **kwargs):
    result = _mutmut_trampoline(x_check_process_exit_code__mutmut_orig, x_check_process_exit_code__mutmut_mutants, args, kwargs)
    return result 
...
def filter_subprocess_kwargs(*args, **kwargs):
    result = _mutmut_trampoline(x_filter_subprocess_kwargs__mutmut_orig, x_filter_subprocess_kwargs__mutmut_mutants, args, kwargs)
    return result 
...
def validate_command_type(*args, **kwargs):
    result = _mutmut_trampoline(x_validate_command_type__mutmut_orig, x_validate_command_type__mutmut_mutants, args, kwargs)
    return result 
