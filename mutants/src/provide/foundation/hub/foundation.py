...
class FoundationManager:
    ...
    def __init__(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁFoundationManagerǁ__init____mutmut_orig"), object.__getattribute__(self, "xǁFoundationManagerǁ__init____mutmut_mutants"), args, kwargs, self)
        return result 
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_orig(self, config: Any = None, force: bool = False) -> None:
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_1(self, config: Any = None, force: bool = True) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_2(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            and self._initialized  # Already initialized (likely auto-init)
            and not force  # User didn't explicitly set force
            and self._config is not None or getattr(self._config, "service_name", "not-none") is None  # Auto-init indicator
        ):
            # Check if OTLP is configured - if so, we MUST do full re-init to recreate LoggerProvider
            # The LoggerProvider bakes service_name into its Resource during creation, so we can't
            # just update the config - we need to recreate it
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_3(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            config is not None  # Explicit config provided
            and self._initialized  # Already initialized (likely auto-init)
            and not force or self._config is not None  # Have existing config to check
            and getattr(self._config, "service_name", "not-none") is None  # Auto-init indicator
        ):
            # Check if OTLP is configured - if so, we MUST do full re-init to recreate LoggerProvider
            # The LoggerProvider bakes service_name into its Resource during creation, so we can't
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_4(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            config is not None  # Explicit config provided
            and self._initialized or not force  # User didn't explicitly set force
            and self._config is not None  # Have existing config to check
            and getattr(self._config, "service_name", "not-none") is None  # Auto-init indicator
        ):
            # Check if OTLP is configured - if so, we MUST do full re-init to recreate LoggerProvider
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_5(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        # config is provided but Foundation is already auto-initialized with defaults
        if (
            config is not None or self._initialized  # Already initialized (likely auto-init)
            and not force  # User didn't explicitly set force
            and self._config is not None  # Have existing config to check
            and getattr(self._config, "service_name", "not-none") is None  # Auto-init indicator
        ):
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_6(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_7(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_8(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_9(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_10(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_11(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_12(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_13(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_14(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            and not force  # User didn't explicitly set force
            and self._config is not None  # Have existing config to check
            and getattr(self._config, "service_name", ) is None  # Auto-init indicator
        ):
            # Check if OTLP is configured - if so, we MUST do full re-init to recreate LoggerProvider
            # The LoggerProvider bakes service_name into its Resource during creation, so we can't
            # just update the config - we need to recreate it
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_15(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_16(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_17(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_18(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_19(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_20(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_21(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            # just update the config - we need to recreate it
            otlp_configured = (
                getattr(self._config, "otlp_endpoint", None) is not None and getattr(config, "otlp_endpoint", None) is not None
            )
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_22(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_23(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_24(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_25(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_26(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            # just update the config - we need to recreate it
            otlp_configured = (
                getattr(self._config, "otlp_endpoint", ) is not None
                or getattr(config, "otlp_endpoint", None) is not None
            )
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_27(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_28(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_29(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_30(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_31(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_32(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_33(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            otlp_configured = (
                getattr(self._config, "otlp_endpoint", None) is not None
                or getattr(config, None) is not None
            )
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_34(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            otlp_configured = (
                getattr(self._config, "otlp_endpoint", None) is not None
                or getattr(config, "otlp_endpoint", ) is not None
            )
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_35(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_36(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_37(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_38(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_39(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_40(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_41(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_42(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_43(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_44(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_45(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_46(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_47(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_48(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_49(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_50(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_51(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_52(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        if (
            ...
            if otlp_configured:
                ...
                if coordinator.update_config_if_default(self._registry, ):
                    # Config updated successfully - no need to re-initialize
                    self._config = config
                    setup_log.info(  # type: ignore[attr-defined]
                        "Foundation: Updated config (explicit service_name overriding auto-init default)"
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_53(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_54(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_55(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_56(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_57(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_58(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_59(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_60(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_61(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_62(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_63(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_64(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_65(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
        ...
        actual_config, logger_instance = coordinator.initialize_foundation(
            registry=self._registry, config=config, )
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_66(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_67(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_68(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_69(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_70(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_71(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_72(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_73(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_74(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_75(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_76(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_77(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_78(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_79(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_80(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_81(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_82(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_83(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_84(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def xǁFoundationManagerǁinitialize_foundation__mutmut_85(self, config: Any = None, force: bool = False) -> None:
        """Initialize Foundation system through Hub.
    ...
    def initialize_foundation(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁFoundationManagerǁinitialize_foundation__mutmut_orig"), object.__getattribute__(self, "xǁFoundationManagerǁinitialize_foundation__mutmut_mutants"), args, kwargs, self)
        return result 
    
    initialize_foundation.__signature__ = _mutmut_signature(xǁFoundationManagerǁinitialize_foundation__mutmut_orig)
    xǁFoundationManagerǁinitialize_foundation__mutmut_orig.__name__ = 'xǁFoundationManagerǁinitialize_foundation'
    ...
    def xǁFoundationManagerǁget_foundation_logger__mutmut_6(self, name: str | None = None) -> Any:
        ...
        # Get logger instance from registry
        logger_instance = self._registry.get("foundation.logger.instance", )
    ...
    def get_foundation_logger(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁFoundationManagerǁget_foundation_logger__mutmut_orig"), object.__getattribute__(self, "xǁFoundationManagerǁget_foundation_logger__mutmut_mutants"), args, kwargs, self)
        return result 
    
    get_foundation_logger.__signature__ = _mutmut_signature(xǁFoundationManagerǁget_foundation_logger__mutmut_orig)
    xǁFoundationManagerǁget_foundation_logger__mutmut_orig.__name__ = 'xǁFoundationManagerǁget_foundation_logger'
    ...
    def xǁFoundationManagerǁget_foundation_config__mutmut_5(self) -> Any | None:
        ...
        # Otherwise get from registry
        return self._registry.get("foundation.config", )
    ...
    def get_foundation_config(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁFoundationManagerǁget_foundation_config__mutmut_orig"), object.__getattribute__(self, "xǁFoundationManagerǁget_foundation_config__mutmut_mutants"), args, kwargs, self)
        return result 
    
    get_foundation_config.__signature__ = _mutmut_signature(xǁFoundationManagerǁget_foundation_config__mutmut_orig)
    xǁFoundationManagerǁget_foundation_config__mutmut_orig.__name__ = 'xǁFoundationManagerǁget_foundation_config'
    ...
    def xǁFoundationManagerǁclear_foundation_state__mutmut_9(self) -> None:
        ...
        # Clear Foundation config from registry to prevent stale state
        if hasattr(self, ) and self._registry:
            # Remove foundation config entries that might have stale state (entry might not exist)
            with contextlib.suppress(Exception):
                self._registry.remove("foundation.config", "singleton")
            with contextlib.suppress(Exception):
    ...
    def xǁFoundationManagerǁclear_foundation_state__mutmut_16(self) -> None:
        ...
        if hasattr(self, "_registry") and self._registry:
            # Remove foundation config entries that might have stale state (entry might not exist)
            with contextlib.suppress(Exception):
                self._registry.remove("foundation.config", )
            with contextlib.suppress(Exception):
                self._registry.remove("foundation.logger.instance", "singleton")
    ...
    def xǁFoundationManagerǁclear_foundation_state__mutmut_25(self) -> None:
        ...
        if hasattr(self, "_registry") and self._registry:
            ...
            with contextlib.suppress(Exception):
                self._registry.remove("foundation.config", "singleton")
            with contextlib.suppress(Exception):
                self._registry.remove("foundation.logger.instance", )
    ...
    def clear_foundation_state(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁFoundationManagerǁclear_foundation_state__mutmut_orig"), object.__getattribute__(self, "xǁFoundationManagerǁclear_foundation_state__mutmut_mutants"), args, kwargs, self)
        return result 
    
    clear_foundation_state.__signature__ = _mutmut_signature(xǁFoundationManagerǁclear_foundation_state__mutmut_orig)
    xǁFoundationManagerǁclear_foundation_state__mutmut_orig.__name__ = 'xǁFoundationManagerǁclear_foundation_state'
    ...
    def _get_logger(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁFoundationManagerǁ_get_logger__mutmut_orig"), object.__getattribute__(self, "xǁFoundationManagerǁ_get_logger__mutmut_mutants"), args, kwargs, self)
        return result 
...
def x_get_foundation_logger__mutmut_6(name: str | None = None) -> Any:
    ...
    hub = get_hub()
    if hasattr(hub, ) and hub._foundation._logger_instance:
        return hub._foundation._logger_instance.get_logger(name)
...
def get_foundation_logger(*args, **kwargs):
    result = _mutmut_trampoline(x_get_foundation_logger__mutmut_orig, x_get_foundation_logger__mutmut_mutants, args, kwargs)
    return result 
