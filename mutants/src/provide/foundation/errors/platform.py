...
class PlatformError(FoundationError):
    ...
    def __init__(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁPlatformErrorǁ__init____mutmut_orig"), object.__getattribute__(self, "xǁPlatformErrorǁ__init____mutmut_mutants"), args, kwargs, self)
        return result 
    ...
    def _default_code(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁPlatformErrorǁ_default_code__mutmut_orig"), object.__getattribute__(self, "xǁPlatformErrorǁ_default_code__mutmut_mutants"), args, kwargs, self)
        return result 
