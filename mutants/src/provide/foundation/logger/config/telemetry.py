...
def x__get_service_name__mutmut_orig() -> str | None:
...
def x__get_service_name__mutmut_1() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv("OTEL_SERVICE_NAME") and os.getenv("PROVIDE_SERVICE_NAME")


def x__get_service_name__mutmut_2() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv(None) or os.getenv("PROVIDE_SERVICE_NAME")


def x__get_service_name__mutmut_3() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv("XXOTEL_SERVICE_NAMEXX") or os.getenv("PROVIDE_SERVICE_NAME")


def x__get_service_name__mutmut_4() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv("otel_service_name") or os.getenv("PROVIDE_SERVICE_NAME")


def x__get_service_name__mutmut_5() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv("OTEL_SERVICE_NAME") or os.getenv(None)


def x__get_service_name__mutmut_6() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv("OTEL_SERVICE_NAME") or os.getenv("XXPROVIDE_SERVICE_NAMEXX")


def x__get_service_name__mutmut_7() -> str | None:
    """Get service name from OTEL_SERVICE_NAME or PROVIDE_SERVICE_NAME (OTEL takes precedence)."""
    return os.getenv("OTEL_SERVICE_NAME") or os.getenv("provide_service_name")
...
def x__get_service_version__mutmut_1() -> str | None:
    """Get service version from package metadata.
...
def x__get_service_version__mutmut_2() -> str | None:
    """Get service version from package metadata.
    ...
    try:
        ...
        return get_version("XXprovide-foundationXX")
    except Exception:
        # Suppress all errors and return None if version can't be determined
        return None


def x__get_service_version__mutmut_3() -> str | None:
    """Get service version from package metadata.
