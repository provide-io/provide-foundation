...
class TestContext:
    ...
    def test_context_update_from_env(self):
    ...
    def test_context_load_config_toml(self):
...
json_output = true
    ...
    def test_context_load_config_json(self):
            ...
            f.write("""
{
    ...
    def test_context_load_config_yaml(self):
...
json_output: true
    ...
    def test_context_save_config(self):
    ...
    def test_context_environment_precedence(self):
