...
def test_safe_read_existing_file(temp_dir) -> None:
...
def test_safe_read_missing_file(temp_dir) -> None:
...
def test_safe_read_with_encoding(temp_dir) -> None:
...
def test_safe_read_text(temp_dir) -> None:
    """Test safe read text."""
    path = temp_dir / "test.txt"
...
def test_safe_read_text_missing_file(temp_dir) -> None:
...
def test_safe_read_text_with_encoding(temp_dir) -> None:
...
def test_safe_delete_existing_file(temp_dir) -> None:
...
def test_safe_delete_missing_file(temp_dir) -> None:
...
def test_safe_delete_missing_not_ok(temp_dir) -> None:
...
def test_safe_move(temp_dir) -> None:
...
def test_safe_move_to_subdir(temp_dir) -> None:
...
def test_safe_move_overwrite(temp_dir) -> None:
...
def test_safe_move_no_overwrite(temp_dir) -> None:
...
def test_safe_move_missing_source(temp_dir) -> None:
...
def test_safe_copy(temp_dir) -> None:
...
def test_safe_copy_to_subdir(temp_dir) -> None:
...
def test_safe_copy_preserves_mode(temp_dir) -> None:
...
def test_safe_copy_no_preserve_mode(temp_dir) -> None:
...
def test_safe_copy_overwrite(temp_dir) -> None:
...
def test_safe_copy_no_overwrite(temp_dir) -> None:
...
def test_safe_copy_missing_source(temp_dir) -> None:
