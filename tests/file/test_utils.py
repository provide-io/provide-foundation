...
def test_get_size_existing_file(temp_dir):
...
def test_get_size_missing_file(temp_dir):
...
def test_get_size_empty_file(temp_dir):
...
def test_get_size_with_string_path(temp_dir):
...
def test_get_mtime_existing_file(temp_dir):
...
def test_get_mtime_missing_file(temp_dir):
...
def test_get_mtime_with_string_path(temp_dir):
...
def test_touch_creates_file(temp_dir):
...
def test_touch_updates_existing_file(temp_dir):
...
def test_touch_with_mode(temp_dir):
...
def test_touch_exist_not_ok(temp_dir):
...
def test_touch_creates_parent_dirs(temp_dir):
...
def test_find_files_non_recursive(temp_dir):
...
def test_find_files_nested_pattern(temp_dir):
...
def test_find_files_missing_root(temp_dir):
...
def test_find_files_excludes_directories(temp_dir):
...
def test_backup_file_basic(temp_dir):
...
def test_backup_file_with_timestamp(temp_dir):
...
def test_backup_file_custom_suffix(temp_dir):
...
def test_backup_file_multiple_backups(temp_dir):
...
def test_backup_file_missing_source(temp_dir):
...
def test_backup_file_preserves_metadata(temp_dir):
