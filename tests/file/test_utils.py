...
class TestFileUtils(FoundationTestCase):
    ...
    def test_get_size_existing_file(self, temp_directory) -> None:
    ...
    def test_get_size_missing_file(self, temp_directory) -> None:
    ...
    def test_get_size_empty_file(self, temp_directory) -> None:
    ...
    def test_get_size_with_string_path(self, temp_directory) -> None:
    ...
    def test_get_mtime_existing_file(self, temp_directory) -> None:
    ...
    def test_get_mtime_missing_file(self, temp_directory) -> None:
    ...
    def test_get_mtime_with_string_path(self, temp_directory) -> None:
    ...
    def test_touch_creates_file(self, temp_directory) -> None:
    ...
    def test_touch_updates_existing_file(self, temp_directory) -> None:
    ...
    def test_touch_with_mode(self, temp_directory) -> None:
    ...
    def test_touch_exist_not_ok(self, temp_directory) -> None:
    ...
    def test_touch_creates_parent_dirs(self, temp_directory) -> None:
    ...
    def test_find_files_basic(self, temp_directory) -> None:
    ...
    def test_find_files_non_recursive(self, temp_directory) -> None:
    ...
    def test_find_files_nested_pattern(self, temp_directory) -> None:
    ...
    def test_find_files_missing_root(self, temp_directory) -> None:
    ...
    def test_find_files_excludes_directories(self, temp_directory) -> None:
    ...
    def test_backup_file_basic(self, temp_directory) -> None:
    ...
    def test_backup_file_with_timestamp(self, temp_directory) -> None:
    ...
    def test_backup_file_custom_suffix(self, temp_directory) -> None:
    ...
    def test_backup_file_multiple_backups(self, temp_directory) -> None:
    ...
    def test_backup_file_missing_source(self, temp_directory) -> None:
    ...
    def test_backup_file_preserves_metadata(self, temp_directory) -> None:
