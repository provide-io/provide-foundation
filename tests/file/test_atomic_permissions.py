...
def test_os_replace_preserves_permissions(temp_dir):
...
def test_atomic_write_default_preserves_existing(temp_dir):
...
def test_atomic_write_explicit_preserve_true(temp_dir):
...
def test_atomic_write_preserve_false_on_existing(temp_dir):
...
def test_atomic_write_preserve_false_on_new(temp_dir):
...
def test_atomic_write_explicit_mode_overrides(temp_dir):
...
def test_atomic_replace_default_preserves(temp_dir):
...
def test_atomic_replace_explicit_preserve_true(temp_dir):
...
def test_atomic_replace_preserve_false(temp_dir):
...
def test_atomic_write_text_preserve_modes(temp_dir):
...
def test_permission_preservation_with_umask(temp_dir):
