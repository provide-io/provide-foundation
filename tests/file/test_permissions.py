...
class TestFormatPermissions:
    ...
    def test_format_basic_permissions(self):
    ...
    def test_format_from_decimal(self):
    ...
    def test_format_masks_file_type_bits(self):
...
class TestSetAndGetPermissions:
    ...
    def test_set_and_get_permissions_on_file(self, tmp_path: Path):
    ...
    def test_set_and_get_permissions_on_directory(self, tmp_path: Path):
    ...
    def test_get_permissions_nonexistent_file(self, tmp_path: Path):
        """Should return 0 for non-existent file."""
        nonexistent = tmp_path / "nonexistent.txt"
        assert get_permissions(nonexistent) == 0

    def test_set_permissions_raises_on_nonexistent(self, tmp_path: Path):
...
class TestEnsureSecurePermissions:
    ...
    def test_ensure_secure_permissions_on_regular_file(self, tmp_path: Path):
    ...
    def test_ensure_secure_permissions_on_executable(self, tmp_path: Path):
    ...
    def test_ensure_secure_permissions_on_directory(self, tmp_path: Path):
    ...
    def test_ensure_secure_permissions_with_custom_modes(self, tmp_path: Path):
    ...
    def test_ensure_secure_permissions_executable_custom_mode(self, tmp_path: Path):
    ...
    def test_ensure_secure_permissions_directory_custom_mode(self, tmp_path: Path):
...
class TestPermissionsRoundTrip:
    ...
    def test_set_get_round_trip(self, tmp_path: Path):
...
class TestPermissionsIntegration:
    ...
    def test_full_workflow_file(self, tmp_path: Path):
    ...
    def test_full_workflow_directory(self, tmp_path: Path):
    ...
    def test_ensure_secure_then_modify(self, tmp_path: Path):
