...
def test_file_lock_acquire_release(temp_dir):
...
def test_file_lock_context_manager(temp_dir):
...
def test_file_lock_non_blocking(temp_dir):
...
def test_file_lock_timeout(temp_dir):
...
def test_file_lock_multiple_releases(temp_dir):
...
def test_file_lock_stale_detection(temp_dir):
...
def test_file_lock_concurrent_access(temp_dir):
...
def test_file_lock_exception_in_context(temp_dir):
...
def test_file_lock_different_process_ownership(temp_dir):
...
def test_file_lock_check_interval(temp_dir):
