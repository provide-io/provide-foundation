...
def test_ensure_dir_creates_new(base_temp_dir):
...
def test_ensure_dir_existing(base_temp_dir):
...
def test_ensure_dir_with_parents(base_temp_dir):
...
def test_ensure_dir_with_mode(base_temp_dir):
...
def test_ensure_dir_file_exists(base_temp_dir):
...
def test_ensure_parent_dir(base_temp_dir):
...
def test_ensure_parent_dir_nested(base_temp_dir):
...
def test_ensure_parent_dir_with_mode(base_temp_dir):
...
def test_ensure_parent_dir_root_file(base_temp_dir):
...
def test_temp_dir_creates_and_cleans():
...
def test_temp_dir_exception_still_cleans():
...
def test_safe_rmtree(base_temp_dir):
...
def test_safe_rmtree_missing_ok(base_temp_dir):
...
def test_safe_rmtree_missing_not_ok(base_temp_dir):
...
def test_safe_rmtree_permission_error():
