...
class TestAlignOffset:
    ...
    def test_align_different_boundaries(self):
    ...
    def test_align_large_values(self):
...
class TestAlignToPage:
    ...
    def test_align_to_4k_page(self):
    ...
    def test_align_to_16k_page(self):
    ...
    def test_align_to_custom_page_size(self):
    ...
    def test_align_zero_to_page(self):
        """Should handle zero offset."""
        assert align_to_page(0) == 0

    def test_align_invalid_page_size(self):
...
class TestIsAligned:
    ...
    def test_is_aligned_different_boundaries(self):
    ...
    def test_is_aligned_with_default(self):
        """Should use DEFAULT_ALIGNMENT when not specified."""
        assert is_aligned(16) == is_aligned(16, DEFAULT_ALIGNMENT)

    def test_is_aligned_invalid_alignment(self):
...
class TestCalculatePadding:
    ...
    def test_calculate_padding_needed(self):
    ...
    def test_calculate_padding_already_aligned(self):
    ...
    def test_calculate_padding_zero_offset(self):
        """Should return 0 for zero offset."""
        assert calculate_padding(0, 16) == 0

    def test_calculate_padding_with_default(self):
        """Should use DEFAULT_ALIGNMENT when not specified."""
        assert calculate_padding(10) == calculate_padding(10, DEFAULT_ALIGNMENT)

    def test_calculate_padding_invalid_alignment(self):
        """Should raise ValueError for invalid alignment."""
        with pytest.raises(ValueError, match="power of 2"):
...
class TestAlignmentIntegration:
    ...
    def test_align_then_check(self):
    ...
    def test_padding_produces_alignment(self):
    ...
    def test_page_alignment_workflow(self):
...
class TestAlignmentEdgeCases:
    ...
    def test_alignment_larger_than_offset(self):
