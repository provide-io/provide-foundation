...
class TestGetAvailableSpace:
    ...
    def test_get_available_space_existing_path(self, tmp_path: Path):
    ...
    def test_get_available_space_nonexistent_path(self, tmp_path: Path):
    ...
    def test_get_available_space_home_directory(self):
    ...
    @patch("os.statvfs")
    def test_get_available_space_handles_os_error(self, mock_statvfs, tmp_path: Path):
...
class TestCheckDiskSpace:
    ...
    def test_check_disk_space_sufficient(self, tmp_path: Path):
    ...
    def test_check_disk_space_insufficient_no_raise(self, tmp_path: Path):
    ...
    def test_check_disk_space_insufficient_raises(self, tmp_path: Path):
    ...
    def test_check_disk_space_default_raises(self, tmp_path: Path):
    ...
    def test_check_disk_space_nonexistent_path(self, tmp_path: Path):
        """Should use parent directory for non-existent path."""
    ...
    def test_check_disk_space_just_under_requirement(self, tmp_path: Path):
    ...
    def test_check_disk_space_one_byte_over(self, tmp_path: Path):
...
class TestGetDiskUsage:
    ...
    def test_get_disk_usage_existing_path(self, tmp_path: Path):
    ...
    def test_get_disk_usage_nonexistent_path(self, tmp_path: Path):
    ...
    def test_get_disk_usage_home_directory(self):
        """Should work with home directory."""
    ...
    @patch("os.statvfs")
    def test_get_disk_usage_handles_os_error(self, mock_statvfs, tmp_path: Path):
        """Should return None when os.statvfs raises OSError."""
        mock_statvfs.side_effect = OSError("Permission denied")
...
class TestDiskUtilitiesIntegration:
    ...
    def test_check_and_get_workflow(self, tmp_path: Path):
    ...
    def test_format_available_space(self, tmp_path: Path):
...
class TestDiskUtilitiesEdgeCases:
    ...
    def test_check_disk_space_zero_requirement(self, tmp_path: Path):
        """Should succeed when requirement is zero."""
        result = check_disk_space(tmp_path, 0, raise_on_insufficient=False)
        assert result is True

    def test_check_disk_space_negative_requirement(self, tmp_path: Path):
    ...
    @patch("os.statvfs")
    def test_all_functions_graceful_failure(self, mock_statvfs, tmp_path: Path):
