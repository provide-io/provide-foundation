...
class TestCommandNotFoundError:
    ...
    def test_command_not_found_with_stderr(self):
        ...
        expected_message = ("Command not available\nCommand: missing_tool\n"
...
class TestProcessTimeoutError:
    ...
    def test_process_timeout_with_outputs(self):
        ...
        expected_message = ("Timeout with output\nCommand: slow_process --verbose\n"
    ...
    def test_process_timeout_with_bytes_outputs(self):
        ...
        expected_message = ("Timeout with bytes\nCommand: binary_process\n"
                          "Process timed out\n--- STDOUT ---\nbinary stdout\n"
                          "--- STDERR ---\nbinary stderr")
        assert str(error) == expected_message
