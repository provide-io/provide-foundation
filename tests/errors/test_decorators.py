...
class TestWithErrorHandling:
    ...
    def test_suppress_specific_errors(self):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_suppress_logging(self, mock_logger):
    ...
    def test_foundation_error_not_wrapped(self):
...
class TestRetryOnError:
    ...
    def test_on_retry_callback_exception(self):
        ...
        assert any("Retry callback failed" in str(call) for call in mock_logger.warning.call_args_list)
    ...
    def test_backoff_parameter(self):
...
class TestSuppressAndLog:
    ...
    def test_suppress_specified_errors(self):
    ...
    def test_other_errors_not_suppressed(self):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_logging_at_warning_level(self, mock_logger):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_logging_at_custom_level(self, mock_logger):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_invalid_log_level_falls_back(self, mock_logger):
...
class TestFallbackOnError:
    ...
    def test_fallback_called_on_error(self):
    ...
    def test_fallback_with_same_arguments(self):
        """Test that fallback receives same arguments."""
        def fallback_func(a, b, c=None):
    ...
    def test_successful_function_not_fallback(self):
    ...
    def test_fallback_error_propagates(self):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_fallback_error_logged(self, mock_logger):
...
class TestCircuitBreaker:
    ...
    def test_failure_count_decreases_on_success(self):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_circuit_open_logged(self, mock_logger):
    ...
    @patch('provide.foundation.errors.decorators.logger')
    def test_recovery_logged(self, mock_logger):
