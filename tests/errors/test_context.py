...
class TestErrorContext:
    ...
    def test_add_namespace_chaining(self):
        """Test chaining namespace additions."""
        ctx = ErrorContext()
        
        ctx.add_namespace("terraform", {"provider": "aws"}) \
           .add_namespace("http", {"status": 500, "method": "POST"})
    ...
    def test_update_namespace_creates_if_missing(self):
    ...
    def test_to_dict_with_tracing(self):
    ...
    def test_to_dict_excludes_empty_tags(self):
    ...
    def test_to_logging_context(self):
    ...
    def test_to_terraform_diagnostic(self):
    ...
    def test_terraform_diagnostic_severity_mapping(self):
    ...
    def test_terraform_diagnostic_without_terraform_namespace(self):
...
class TestCaptureErrorContext:
    ...
    def test_capture_with_severity_override(self):
    ...
    def test_capture_with_category_override(self):
    ...
    def test_capture_with_namespaces(self):
    ...
    def test_severity_inference_for_value_errors(self):
    ...
    def test_severity_inference_for_lookup_errors(self):
    ...
    def test_category_inference_for_user_errors(self):
    ...
    def test_category_inference_for_external_errors(self):
    ...
    def test_capture_foundation_error_context(self):
    ...
    def test_capture_foundation_error_merges_namespaces(self):
        ...
        assert ctx.get_namespace("aws") == {
            "region": "us-east-1",
            "account": "123"
        }
    
    def test_capture_complex_namespace_parsing(self):
...
class TestErrorContextIntegration:
    ...
    def test_context_with_error_chain(self):
