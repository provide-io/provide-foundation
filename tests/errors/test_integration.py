...
from provide.foundation.errors.types import ErrorCode, ErrorMetadata, RetryPolicy
...
class TestErrorSystemIntegration:
    ...
    def test_error_handler_chain(self):
        ...
        handler2 = ErrorHandler(
            policies={
                ConfigurationError: lambda e: results.append("config") or "c"
            },
    ...
    def test_context_vars_integration(self):
        ...
        error = create_contextualized_error(
            "Operation failed",
    ...
    def test_terraform_diagnostic_integration(self):
    ...
    def test_error_recovery_strategies(self):
        ...
        assert call_log == ["retry", "retry", "retry", "primary", "fallback", "suppress"]
    
    def test_error_metadata_and_response(self):
    ...
    def test_custom_error_extension(self):
...
class TestRealWorldScenarios:
    ...
    def test_web_request_error_handling(self):
