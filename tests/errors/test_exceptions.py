...
class TestFoundationError:
    ...
    def test_to_dict_with_namespaced_context(self):
    ...
    def test_default_code_override(self):
...
class TestRuntimeError:
    ...
    def test_with_retry_possible(self):
...
class TestResourceError:
    ...
    def test_with_resource_path(self):
...
class TestNetworkError:
    ...
    def test_inheritance_from_integration_error(self):
...
class TestTimeoutError:
    ...
    def test_with_elapsed_seconds(self):
...
class TestConcurrencyError:
    ...
    def test_with_version_expected(self):
    ...
    def test_with_version_actual(self):
...
class TestErrorInheritance:
    ...
    def test_all_errors_inherit_from_foundation_error(self):
    ...
    def test_network_and_timeout_inherit_from_integration(self):
