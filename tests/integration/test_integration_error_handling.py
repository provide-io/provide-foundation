...
class TestErrorHandlingIntegration:
    ...
    async def test_config_loader_error_handling(self):
    ...
    async def test_async_error_handling(self):
        ...
        async def async_func(should_fail: bool = False):
            if should_fail:
    ...
    def test_error_logging_integration(self, captured_stderr_for_foundation):
