...
class TestParsingCoverage:
    ...
    def test_parse_bool_with_strict_mode_non_string(self):
    ...
    def test_parse_bool_invalid_string_value(self):
    ...
    def test_parse_list_with_no_strip(self):
    ...
    def test_parse_list_with_custom_separator(self):
        """Test parse_list with custom separator."""
        result = parse_list("a|b|c", separator="|")
        assert result == ["a", "b", "c"]

    def test_parse_list_already_list(self):
    ...
    def test_parse_dict_with_empty_items(self):
        """Test parse_dict handles empty items."""
        result = parse_dict("a=1,,b=2")
        assert result == {"a": "1", "b": "2"}

    def test_parse_dict_missing_separator(self):
    ...
    def test_parse_dict_with_multiple_equals_in_value(self):
    ...
    def test_parse_typed_value_with_none(self):
        """Test parse_typed_value handles None value."""
        assert parse_typed_value(None, str) is None

    def test_parse_typed_value_with_int_and_float(self):
    ...
    def test_parse_typed_value_with_typed_list_conversion_error(self):
    ...
    def test_parse_typed_value_with_untyped_list(self):
    ...
    def test_auto_parse_with_type_attribute(self):
    ...
    def test_auto_parse_with_string_type_name(self):
    ...
    def test_auto_parse_with_unknown_string_type(self):
    ...
    def test_auto_parse_without_type(self):
    ...
    def test_auto_parse_all_string_type_mappings(self):
