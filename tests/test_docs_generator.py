...
class TestAPIDocGenerator:
    ...
    def test_init_mkdocs_gen_files_unavailable(self):
    ...
    def test_should_skip_small_init_files(self):
    ...
    def test_should_skip_private_modules(self):
    ...
    def test_get_module_identifier_with_prefix(self):
    ...
    def test_get_module_identifier_without_prefix(self):
    ...
    def test_generate_module_doc_with_options(self):
    ...
    def test_process_python_file_regular_module(self):
    ...
    def test_process_python_file_init_module(self):
    ...
    def test_process_python_file_duplicate(self):
    ...
    def test_generate_index_custom_content(self):
    ...
    def test_generate_index_default_content(self):
...
class TestGenerateApiDocs:
    ...
    def test_generate_api_docs_default_args(self):
    ...
    def test_generate_api_docs_custom_args(self):
