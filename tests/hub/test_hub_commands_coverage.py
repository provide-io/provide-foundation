...
class TestLazyLoadingFeatures:
    ...
    def test_getattr_nonexistent_attribute(self):
        ...
        with pytest.raises(AttributeError, match="module 'provide.foundation.hub.commands' has no attribute 'nonexistent'"):
...
class TestClickDependencyHandling:
    ...
    def test_click_import_error_handling_build_click_command(self):
        ...
        with patch('builtins.__import__') as mock_import:
            ...
            with pytest.raises(ImportError, match="CLI feature 'build_click_command' requires: pip install"):
    ...
    def test_click_import_error_handling_create_command_group(self):
        ...
        with patch('builtins.__import__') as mock_import:
            ...
            with pytest.raises(ImportError, match="CLI feature 'create_command_group' requires: pip install"):
...
class TestModuleBehavior:
    ...
    def test_lazy_loading_error_doesnt_break_core(self):
        ...
        from provide.foundation.hub.commands import get_command_registry, register_command
