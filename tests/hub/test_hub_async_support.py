...
from provide.foundation.hub import Hub, get_hub, clear_hub, register_command, register_component
...
class TestAsyncRegistryCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_registry_operations_in_async_context(self):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_async_registry_operations(self):
    ...
    @pytest.mark.asyncio
    async def test_registry_iteration_in_async(self):
...
class TestAsyncHubCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_hub_operations_in_async_context(self):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_async_hub_access(self):
...
class TestAsyncLoggerCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_logger_in_async_context(self):
...
class TestAsyncContextManagers:
    ...
    @pytest.mark.asyncio
    async def test_async_component_lifecycle(self):
    ...
    @pytest.mark.asyncio
    async def test_async_with_sync_registry(self):
...
class TestAsyncTaskCoordination:
    ...
    async def test_producer_consumer_pattern(self):
        ...
        async def consumer(consumer_id: int, max_items: int):
    ...
    async def test_async_event_handling(self):
        ...
        async def event_handler(event_type: str, data: Any):
...
class TestAsyncMixedOperations:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_sync_async_access(self):
