...
class TestComponentRegistration:
    ...
    def test_register_component_with_dimension(self):
    ...
    def test_register_component_auto_name(self):
    ...
    def test_register_component_with_base_class(self):
    ...
    def test_component_info_stored(self):
    ...
    def test_register_component_with_replace(self):
    ...
    def test_list_components_by_dimension(self):
    ...
    def test_component_factory_pattern(self):
