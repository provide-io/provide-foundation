...
def test_config_allocations(memray_output_dir, memray_baseline):
    ...
    assert_allocation_within_threshold("config_total_allocations", total_allocs, memray_baseline)
