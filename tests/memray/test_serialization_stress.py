...
def test_serialization_allocations(memray_output_dir, memray_baseline):
    ...
    output_file = memray_output_dir / "serialization_stress.bin"
    ...
    assert_allocation_within_threshold("serialization_total_allocations", total_allocs, memray_baseline)
