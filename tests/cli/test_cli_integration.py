...
class TestCompleteCliIntegration:
    ...
    def create_test_cli(self):
        ...
        @flexible_options
        @pass_context
        def database(ctx: Context, **kwargs):
    ...
    def test_options_at_group_level(self):
    ...
    def test_options_at_subcommand_level(self):
    ...
    def test_nested_groups_inherit_options(self):
    ...
    def test_command_options_override_group_options(self):
...
class TestLoggingIntegration:
    ...
    def test_log_level_affects_output(self, mock_logger_class):
    ...
    def test_log_format_changes_output(self):
    ...
    def test_log_file_writes_to_file(self):
...
class TestRealWorldScenarios:
    ...
    def test_debugging_production_issue(self):
        ...
        @output_options
        @pass_context
        def diagnose(ctx: Context, **kwargs):
            """Run diagnostics."""
    ...
    def test_ci_cd_pipeline_usage(self):
        """Test scenario: running in CI/CD pipeline."""
        @click.command()
        @flexible_options
        @output_options
        @pass_context
        def deploy(ctx: Context, **kwargs):
            """Deploy application."""
    ...
    def test_interactive_development(self):
        """Test scenario: interactive development with verbose output."""
        @click.command()
        @flexible_options
        @output_options
        @pass_context
        def develop(ctx: Context, **kwargs):
            """Development command."""
