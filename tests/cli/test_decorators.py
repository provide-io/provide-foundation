...
class TestLoggingOptions:
    ...
    def test_adds_log_level_option(self):
    ...
    def test_adds_log_file_option(self):
    ...
    def test_adds_log_format_option(self):
...
class TestOutputOptions:
    ...
    def test_adds_json_option(self):
    ...
    def test_adds_no_color_option(self):
    ...
    def test_adds_no_emoji_option(self):
    ...
    def test_no_verbose_or_quiet_options(self):
...
class TestConfigOptions:
    ...
    def test_adds_config_option(self):
    ...
    def test_adds_profile_option(self):
...
class TestFlexibleOptions:
    ...
    def test_combines_logging_and_config(self):
    ...
    def test_can_be_used_on_groups_and_commands(self):
...
class TestPassContext:
    ...
    def test_updates_context_from_options(self):
...
class TestVersionOption:
    ...
    def test_adds_version_option(self):
...
class TestOptionInheritance:
    ...
    def test_subcommand_inherits_parent_options(self):
    ...
    def test_subcommand_can_override_parent_options(self):
...
class TestEnvironmentVariables:
    ...
    def test_all_options_support_env_vars(self):
