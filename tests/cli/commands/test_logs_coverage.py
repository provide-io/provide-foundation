...
class TestLogsCLIBasicCoverage:
    ...
    def test_logs_group_stub_when_click_missing(self):
    ...
    def test_query_command_import(self):
    ...
    def test_send_command_import(self):
    ...
    def test_tail_command_import(self):
    ...
    def test_logs_has_click_flag(self):
    ...
    def test_logs_all_exports(self):
