...
class TestRegistry:
    ...
    def test_registry_stores_by_dimension(self):
    ...
    def test_registry_get_without_dimension(self):
    ...
    def test_registry_allows_same_name_different_dimensions(self):
    ...
    def test_registry_aliases(self):
        ...
        reg.register("primary", "value", dimension="component", aliases=["alt1", "alt2"])
    ...
    def test_registry_list_dimension(self):
    ...
    def test_registry_clear_dimension(self):
