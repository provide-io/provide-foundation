...
class TestLoggingDefaults:
    ...
    def test_foundation_logging_defaults(self):
...
class TestTelemetryDefaults:
    ...
    def test_global_telemetry_default(self):
    ...
    def test_trace_sample_rate_default(self):
...
class TestProcessDefaults:
    ...
    def test_process_timeout_defaults(self):
...
class TestFileDefaults:
    ...
    def test_file_lock_timeout_default(self):
...
class TestIntegrationDefaults:
    ...
    def test_openobserve_defaults(self):
...
class TestTestingDefaults:
    ...
    def test_testing_timeout_defaults(self):
...
class TestTempFileDefaults:
    ...
    def test_temp_file_defaults(self):
...
class TestDirectoryDefaults:
    ...
    def test_directory_mode_validity(self):
...
class TestAtomicWriteDefaults:
    ...
    def test_atomic_write_defaults(self):
        """Test atomic write defaults."""
...
class TestFactoryFunctions:
    ...
    def test_default_rate_limits(self):
        ...
        assert isinstance(list(result1.keys())[0], str)
        assert isinstance(list(result1.values())[0], tuple)
        assert len(list(result1.values())[0]) == 2
        assert isinstance(list(result1.values())[0][0], float)
        assert isinstance(list(result1.values())[0][1], float)

    def test_default_otlp_headers(self):
...
class TestDefaultConsistency:
    ...
    def test_boolean_defaults_consistency(self):
    ...
    def test_string_defaults_not_empty(self):
