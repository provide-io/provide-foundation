...
class TestConfigError:
    ...
    def test_config_error_inherits_from_foundation_error(self):
    ...
    def test_config_error_with_kwargs(self):
...
class TestParseError:
    ...
    def test_parse_error_with_expected_type(self):
    ...
    def test_parse_error_with_valid_options(self):
    ...
    def test_parse_error_with_all_parameters(self):
...
class TestValidationError:
    ...
    def test_validation_error_inherits_from_config_error(self):
    ...
    def test_validation_error_required_parameters(self):
...
class TestFormatInvalidValueError:
    ...
    def test_format_with_field_and_value_only(self):
    ...
    def test_format_with_valid_options(self):
    ...
    def test_format_with_expected_type(self):
    ...
    def test_format_with_additional_info(self):
    ...
    def test_format_prefers_valid_options_over_expected_type(self):
    ...
    def test_format_with_numeric_value(self):
...
class TestFormatValidationError:
    ...
    def test_format_basic_validation_error(self):
    ...
    def test_format_with_boolean_value(self):
...
class TestErrorIntegration:
    ...
    def test_parse_error_with_formatted_message(self):
