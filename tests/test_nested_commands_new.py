...
class TestDotNotationCommands:
    ...
    def test_simple_nested_command(self):
    ...
    def test_command_with_parameters(self):
        ...
        # Test with options
        result = runner.invoke(cli, ["db", "migrate", "--direction", "down", "--steps", "3"])
    ...
    def test_help_text_navigation(self):
    ...
    def test_boolean_flags(self):
        ...
        def deploy_app(env: str = "staging", force: bool = False, verbose: bool = False):
            """Deploy application."""
            if verbose:
        ...
        # Test with flags
        result = runner.invoke(cli, ["deploy", "app", "--env", "prod", "--force", "--verbose"])
        assert result.exit_code == 0
    ...
    def test_hidden_groups_and_commands(self):
    ...
    def test_same_command_names_different_groups(self):
    ...
    def test_auto_group_description(self):
...
class TestDotNotationIntegration:
    ...
    def test_realistic_cli_application(self):
        ...
        def server_logs_show(lines: int = 100, follow: bool = False):
            """Show server logs."""
        ...
        tests = [
            ...
            (["server", "start", "--port", "3000"], "Server starting on localhost:3000"),
            (["server", "stop"], "Server stopped"),
            (["server", "logs", "show", "--lines", "50", "--follow"], "Showing 50 lines"),
    ...
    def test_mixed_explicit_and_auto_groups(self):
        ...
        def api_auth_login(username: str, password: str = None):
            """Login."""
        ...
        # Test commands work
        result = runner.invoke(cli, ["api", "users", "create", "john", "john@example.com"])
        assert result.exit_code == 0
