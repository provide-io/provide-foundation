...
class TestTraceProcessorWithOtel:
    ...
    def test_inject_trace_context_with_otel_span(self):
    ...
    def test_inject_trace_context_otel_not_recording(self):
...
class TestTraceProcessorWithoutOtel:
    ...
    def test_inject_trace_context_foundation_only(self):
    ...
    def test_inject_trace_context_no_trace_or_span(self):
    ...
    def test_inject_trace_context_foundation_exception(self):
...
class TestTraceProcessorImports:
    ...
    def test_otel_import_handling(self):
        ...
        # If not, it should be False and otel_trace should be None
        if trace._HAS_OTEL:
            assert trace.otel_trace is not None
        else:
            assert trace.otel_trace is None


class TestShouldInjectTraceContext:
    """Test should_inject_trace_context function."""
    
    def test_should_inject_with_otel_active_span(self):
        """Test should inject when OpenTelemetry has active span."""
        from provide.foundation.logger.processors.trace import should_inject_trace_context
    ...
    def test_should_not_inject_otel_not_recording(self):
        ...
        with patch('provide.foundation.logger.processors.trace._HAS_OTEL', True):
            with patch('provide.foundation.logger.processors.trace.otel_trace') as mock_otel:
                ...
                with patch('provide.foundation.tracer.context.get_current_span', return_value=None):
                    with patch('provide.foundation.tracer.context.get_current_trace_id', return_value=None):
    ...
    def test_should_inject_foundation_span(self):
    ...
    def test_should_inject_foundation_trace_id_only(self):
    ...
    def test_should_not_inject_no_context(self):
    ...
    def test_should_not_inject_foundation_exception(self):
