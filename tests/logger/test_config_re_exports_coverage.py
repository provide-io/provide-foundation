...
class TestLoggerConfigReExports:
    ...
    def test_logging_config_import(self):
        ...
        from provide.foundation.logger.config.logging import LoggingConfig as OriginalLoggingConfig
    ...
    def test_telemetry_config_import(self):
        ...
        # Verify it's the same class as the original
        from provide.foundation.logger.config.telemetry import TelemetryConfig as OriginalTelemetryConfig
