...
# Convenience functions for backwards compatibility with tests
_default_generator = LogGenerator()


def generate_trace_id() -> str:
    """Generate a unique trace ID using the default generator.

    Returns:
        Formatted trace ID string

    """
    return _default_generator.generate_trace_id()


def generate_span_id() -> str:
    """Generate a unique span ID using the default generator.

    Returns:
        Formatted span ID string

    """
    return _default_generator.generate_span_id()
