...
Environment Configuration:
    PROVIDE_TRANSPORT_TIMEOUT=30.0
    PROVIDE_TRANSPORT_MAX_RETRIES=3
    PROVIDE_TRANSPORT_RETRY_BACKOFF_FACTOR=0.5
    PROVIDE_TRANSPORT_VERIFY_SSL=true

    PROVIDE_HTTP_POOL_CONNECTIONS=10
    PROVIDE_HTTP_POOL_MAXSIZE=100
    PROVIDE_HTTP_FOLLOW_REDIRECTS=true
    PROVIDE_HTTP_USE_HTTP2=true
    PROVIDE_HTTP_MAX_REDIRECTS=5
"""
